...
#define WND_TITLE   "Lab05-Bai04"               /* tieu de */ 
...
int yMotion = 0;
vec3 shade = { 1.0, 0.0, 0.0 }; //Gia tri mau cua van nhieu
...
void render() //Dunh hinh khung canh
{ 
	//Truyen cac gia tri can thiet fragment shader 
