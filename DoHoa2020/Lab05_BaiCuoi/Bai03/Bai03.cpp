...
vec3 ambient = { 1.0f, 1.0f, 1.0f };       /* màu ambient  0.1-0.1-0.1*/
vec3 diffuse = { 0.5f, 0.5f, 0.5f };       /* màu diffuse 1.0-0.5-0.0*/
vec3 specular = { 1.0f, 0.5f, 1.0f };       /* màu specular 1.0-1.0-1.0*/
