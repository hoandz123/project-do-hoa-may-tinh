...
typedef enum glslShader { VERTEX_SHADER, FRAGMENT_SHADER } GLSL_SHADER; //Kieu doi tuong shader can thao tac

typedef struct glslProgram //Doi tuong chuong trinh shader GLSL
{
	GLuint program;
	GLboolean linked;
} GLSL_PROGRAM;

//Cac ham xu ly tren doi tuong chuong trinh shader
