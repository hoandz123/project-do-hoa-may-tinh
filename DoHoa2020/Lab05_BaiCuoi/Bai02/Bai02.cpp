...
#define WND_TITLE   "Lab05-Bai02"               /* tieu de */ 
...
void render() //Dung hinh 
{
	...
	glRotatef(xAngle, 1.0f, 0.0f, 0.0f);/*1-0-0*/
	glRotatef(yAngle, 0.0f, 1.0f, 0.0f);/*0-1-0*/
	glRotatef(zAngle, 0.0f, 0.0f, 1.0f);/*0-0-1*/

	switch (obj)
	{
	case CUBE:      glutSolidCube(1.5f); break;
	case SPHERE:    glutSolidSphere(1.0f, 24, 24); break;
	case TORUS:     glutSolidTorus(0.5, 1.0f, 24, 24); break; //nút đen tròn dưới đáy bình
