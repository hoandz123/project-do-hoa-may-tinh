...
float lastXOffset = 0.0,
lastYOffset = 0.0, lastZOffset = 0.0;
...
void mouseFunc(int button, int state, int x, int y)
{
	...
	if (button == GLUT_LEFT_BUTTON)
		...
		else middleMouseButtonActive -= 1;
...
{
	printf("simpleGlut\n\tGordon Wetzstein [gordon.weizstein@medien.uni-weimar.de]\n\n");
	printf("keys:\n\tf\t- toggle fullscreen\n\tesc\t exit\n\n");
	printf("mouse:\n\tleft button\t rotation\n\tmiddle button\t-panning\n\tright button\-t zoom int and out\n");
